...
class Edge
{
    public static Vertex     dest;   // Second vertex in Edge
    public static double     cost;   // Edge cost
...
{
    public static Vertex     dest;   // w
    public static double     cost;   // d(w)
...
public class SimulatorOne
{
     ...
     */
    public static void addEdge( String sourceName, String destName, double cost )
    {
     ...
     */
    public static void printPath( String destName )
    {
	...
	static double outcost = 0.0 ;

	 public static String printPath1( String destName )
    {
        Vertex w = vertexMap.get( destName );
        if( w == null )
            throw new NoSuchElementException( "Destination vertex not found" );
	...
	public static String printPath1( Vertex dest )
    {
        if( dest.prev != null )
        {
...
/**
	...
	public double calculateCost(String start, String dest, Graph g){
    ...
    public static void main( String [ ] args )
    {
	    ...
	    PrintWriter writer = new PrintWriter("me.txt", "UTF-8");
		...
		writer.close();
        	...
        	FileReader fin = new FileReader("me.txt");
